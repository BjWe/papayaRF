#ifndef si4432_enums_h
#define si4432_enums_h

enum SI4432_Register {
  DEVICE_TYPE = 0x00,
  DEVICE_VERSION = 0x01,
  DEVICE_STATUS = 0x02,
...
enum SI4432_Modulation_Data_Source {
  DIRECT_GPIO = 0x00,
  DIRECT_SDI = 0x01,
  FIFO = 0x02,
  PN9 = 0x03
...
enum SI4432_CRC_Mode {
  CRC_DISABLED,
  CRC_DATA_ONLY,
  CRC_NORMAL,
};

enum SI4432_CRC_Polynomial {
  CCITT = 0x00,
  CRC16 = 0x01,
  IEC16 = 0x02,
  BIACHEVA = 0x03,
...
enum SI4432_Data_Clock_Configuration {
  NONE = 0x00,
  GPIO = 0x01,
  SDO = 0x02,
  NIRQ = 0x03
